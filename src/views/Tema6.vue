  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 6
      h1 Escalado del corpiño para brasiere
    ...
    .row.justify-content-evenly.mb-4      
      .col-lg-5.d-flex.align-items-center
        div.mb-4          
          ...
          h4.mb-0 El corpiño para brasier está compuesto por dos piezas, la ½ del frente y la ½ de la espalda, moldes a los que se aplican incrementos del cuadro tallas. 
      .col-lg-5.col-8.px-5
        figure.mb-4
